...
function PodCast() {
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 mb-10 sm:mb-16 md:mb-20 lg:mb-28 mt-10 sm:mt-16 md:mt-20">
      <div className="max-w-[995.35px] mx-auto">
      ...
      <div className="flex flex-wrap justify-center items-center mt-8 sm:mt-12 md:mt-16 lg:mt-20 gap-4 sm:gap-6 md:gap-8 lg:gap-24">
        <img src="image/podcast.svg" alt="Podcast" className="w-full sm:w-1/2 md:w-1/4 lg:w-auto" />
        <img src="image/podcast.svg" alt="Podcast" className="w-full sm:w-1/2 md:w-1/4 lg:w-auto sm:mt-[16px] mt-[16px] md:mt-[0]" />
        <img src="image/podcast.svg" alt="Podcast" className="w-full sm:w-1/2 md:w-1/4 lg:w-auto sm:mt-[16px] mt-[16px] md:mt-[0]" />
        <img src="image/podcast.svg" alt="Podcast" className="w-full sm:w-1/2 md:w-1/4 lg:w-auto sm:mt-[16px] mt-[16px] md:mt-[0]" />
      </div>
